...
const VehicleDetails = () => {
    ...
    const getImageUrl = (path) => {
        ...
        return `https://joshautos.onrender.com${path}`;
    };
    ...
    useEffect(() => {
        ...
        axios.get(`https://joshautos.onrender.com/api/cars/${cleanId}`)
            .then(res => {
                if (res.data.success) {
                    setCar(res.data.car);
    ...
    const handlePaymentSuccess = async (reference) => {
        ...
        try {
            ...
            const res = await axios.put(`https://joshautos.onrender.com/api/cars/${id}`, {
                ...car,
    ...
    const handleLeadSubmit = async (e) => {
        ...
        try {
            const res = await axios.post('https://joshautos.onrender.com/api/inquiries',
    ...
    const handleUpdateCar = async (e) => {
        ...
        try {
            const res = await axios.put(`https://joshautos.onrender.com/api/cars/${id}`, formData, {
                headers: {
    ...
    const handleDeleteCar = async () => {
        ...
        const token = localStorage.getItem('token');
        try {
            const res = await axios.delete(`https://joshautos.onrender.com/api/cars/${id}`, {
                headers: { 'Authorization': `Bearer ${token}` }
            });
            if (res.data.success) {
